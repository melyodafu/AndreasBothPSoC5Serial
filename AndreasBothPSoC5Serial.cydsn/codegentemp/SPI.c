...
#include "SPI_PVT.h"
    ...
    volatile uint16 SPI_txBuffer[SPI_TX_BUFFER_SIZE];
    ...
    volatile uint16 SPI_rxBuffer[SPI_RX_BUFFER_SIZE];
...
void SPI_WriteTxData(uint16 txData) 
{
           ...
           (0u != (SPI_swStatusTx & SPI_STS_TX_FIFO_NOT_FULL)))
        {
            ...
            CY_SET_REG16(SPI_TXDATA_PTR, txData);
        }
        else
        {
...
void SPI_ClearRxBuffer(void) 
{
    ...
    {
        (void) CY_GET_REG16(SPI_RXDATA_PTR);
    }
