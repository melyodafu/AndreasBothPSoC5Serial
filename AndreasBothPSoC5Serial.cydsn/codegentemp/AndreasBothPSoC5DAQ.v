...
module SPI_Master_v2_50_3 (
	...
	cy_clock_v1_0
		#(.id("b4b1c04f-b799-4731-a2b9-7475a03381f9/426fcbe0-714d-4404-8fa8-581ff40c30f1"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
	...
	cy_clock_v1_0
		#(.id("679ae50f-26ee-4a42-afdb-db6883fd8a04"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("625000000"),
		  .is_direct(0),
    ...
    defparam SPI.NumberOfDataBits = 15;
	...
	cy_psoc3_pins_v1_10
		#(.id("02c9ecf3-ca4c-4753-b0f9-29eb6c6d82cb"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
